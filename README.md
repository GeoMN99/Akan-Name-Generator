...
1. Clone the repository to your computer:
   git clone git@github.com:GeoMN99/Akan-Name-Generator.git
2. Open the project folder:
3. Open the 'index.html' file in your browser to run the application.

No additional installations or dependencie are required.

## Live Site
View the site here: (https://geomn99.github.io/Akan-Name-Generator/)
...
Copyright 2026 George Ngunjiri
